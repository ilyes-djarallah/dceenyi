const translations = {
  en: {
    ...
    privateSetif: "Private apartment - Setif",
    privateAnnaba: "Private apartment - Annaba",
    privateConstantine: "Private apartment - Constantine",
    setif: "Setif",
    batna: "Batna",
    constantine: "Constantine",
    aliMendjeli: "Ali Mendjeli",
    riyadh: "Riyadh",
    riyadhSurf: "- 80 m² -",
    ...
    riyadhInfo: "Type: interior | Location: Riyadh, Batna | Surface: 80 m²",
    aliInfo:
      "Type: interior | Location: Ali Mendjeli, Constantine | Surface: 9 m²",
    hamla: "Hamla 2",
    hamlaSurf: "- 16 m² -",
    ...
    tazoult: "Tazoult",
    tazoultSurf: "- 80 m² -",
    tazoultInfo: "Type: interior | Location: Batna, Algeria | Surface: 80 m²",
    ...
    cheraga: "Chéraga",
    cheragaSurf: "- 17 m² -",
    cheragaInfo: "Type: interior | Location: Chéraga, Algiers | Surface: 17 m²",
    oran: "Oran",
    ...
    kantaraSurf: "- 20 m² -",
    kantaraInfo:
      "Type: interior | Location: El Kantara, Biskra | Surface: 20 m²",
    privateBiskra: "Private apartement - Biskra",
    indonesia: "Indonesia",
    bali: "Bali",
    baliSurf: "- 60 m² -",
    baliInfo: "Type: interior | Location: Bali, Indonesia | Surface: 60 m²",
    privateIndonesia: "Spa shop - Bali",
    france: "France",
    lyon: "Lyon",
    franceSurf: "- 120 m² -",
    franceInfo: "Type: interior | Location: Lyon, France | Surface: 120 m²",
    privateFrance: "Restaurant - Lyon",
    morocco: "Morocco",
    marrakesh: "Marrakesh",
    marrakeshSurf: "- 75 m² -",
    marrakeshInfo:
      "Type: interior | Location: Marrakesh, Morroco | Surface: 75 m²",
    privatemarrakesh: "Barber shop - Marrakesh",
    malaysia: "Malaysia",
    kuala: "Kuala Lumpur",
    kualaSurf: "- 70 m² -",
    kualaInfo:
      "Type: interior | Location: Kuala Lumpur, Malaysia | Surface: 70 m²",
    privateKuala: "Restaurant - Kuala Lumpur",
    ksa: "Saudi Arabia",
    riyadhh: "Riyadh",
    riyadhhSurf: "- 130 m² -",
    riyadhhInfo:
      "Type: interior | Location: Riyadh, Saudi Arabia | Surface: 130 m²",
    privateRiyadhh: "Jewelry store - Riyadh",
    egypt: "Egypt",
    hurghada: "Hurghada",
    hurghadaSurf: "- 150 m² -",
    hurghadaInfo:
      "Type: interior | Location: Hurghada, Egypt | Surface: 150 m²",
    privateHurghada: "Restaurent - Hurghada",

    belvedere: "Belvedere",
    belvedereSurf: "- 55 m² -",
    belvedereInfo:
      "Type: interior | Location: Annaba, Algeria | Surface: 55 m²",
    ...
    draria: "Draria",
    drariaSurf: "- 16 m² -",
    drariaInfo: "Type: interior | Location: Draria, Algiers | Surface: 16 m²",
    ...
    belvedereSaunaInfo:
      "Type: interior | Location: Oran, Annaba | Surface: 60 m²",
    ...
    tazoultTwoInfo:
      "Type: Exterior | Location: Tazoult, Batna | Surface: 400 m²",

    privateIndonesiaa: "Private apartment - Indonesia",
    jakarta: "Jakarta",
    jakartaSurf: "- 70 m² -",
    jakartaInfo:
      "Type: interior | Location: Jakarta, Indonesia | Surface: 70 m²",

    privateApartIndonesia: "Private apartment - Indonesia",

    cheragaTwo: "Cheraga -2-",
    cheragaTwoSurf: "- 50 m² -",
    cheragaTwoInfo:
      "Type: interior | Location: Chéraga, Algiers | Surface: 50 m²",
    ...
    learningDesc:
      "Training courses and education from a top interior design studio",

    dontforget: "Don't forget to check our projects!",

    publicHydra: "Pilates Studio - Hydra",
    hydra: "Hydra",
    hydraSurf: "- 80 m² -",
    hydraInfo: "Type: interior | Location: Algiers, Algeria | Surface: 80 m²",

    publicGymRiyadh: "Gym - Doha",
    gymRiyadh: "Riyadh",
    gymRiyadhSurf: "- 90 m² -",
    gymRiyadhInfo: "Type: interior | Location: Doha, Qatar | Surface: 90 m²",

    publicSaunaAnnaba: "Sauna - Oran",
    saunaAnnaba: "Annaba",
    saunaAnnabaSurf: "- 60 m² -",
    saunaAnnabaInfo:
      "Type: interior | Location: Annaba, Algeria | Surface: 60 m²",

    publicSaudi: "Director’s Office - Riyadh",
    directorDesk: "Riyadh",
    riyadhhSurf: "- 30 m² -",
    riyadhhInfo:
      "Type: interior | Location: Riyadh, Saudi Arabia | Surface: 30 m²",

    algeria: "Algeria",

    privateMalaysia: "Private apartement - Kuala Lumpur",

    skikda: "Skikda",
    privateSkikda: "Private apartement - Skikda",
    skikdaInfo: "Type: interior | Location: Skikda, Algeria | Surface: 16 m²",

    azerbaijan: "Azerbaijan",
    baku: "Baku",
    privateAzerbaijan: "Private apartement - Baku",
    azerbaijanInfo:
      "Type: interior | Location: Azerbaijan, Baku | Surface: 50 m²",
    ...
    vietnam: "Vietnam",
    hanoi: "Hanoi",
    publicVietnam: "Stand Exhibition - Hanoi",
    publicVietnamInfo:
      "Type: interior | Location: Vietnam, Hanoi | Surface: 25 m²",
    hanoiSurf: "- 25 m² -",

    publicBatna: "Coffee Shop- Batna",
    publicbatnaInfo:
    ...
    // buy_now: "Buy Now",
    aiRenderTitle:
      "AI Rendering Mastery: Turn Your SketchUp/Revit Models into Realistic Renders",
    aiRenderShortDesc:
      "Stop wasting hours on traditional rendering — learn how to produce high-quality 3D images and scenes in just minutes.",
    aiRenderLongDesc:
      "Rendering takes too long, realistic results are hard to achieve, and clients always want changes fast. This course teaches you how to create professional realistic renders and animations in minutes — with less effort and zero stress and using free AI tools.",
    // Chapters
    ch1Title: "Chapter 1 — Introduction & Foundations",
    ch1_1: "Understand the course structure",
    ch1_2: "Important notes about mnml.ai",
    ch2Title: "Chapter 2 — Getting Started with mnml.ai",
    ch2_1: "Create your mnml.ai account free method",
    ch2_2: "Learn the interface and main tools",
    ch2_3: "First steps to navigate and use the platform correctly",
    ch3Title: "Chapter 3 — Preparing Your Workflow (Revit + SketchUp)",
    ch3_1: "Learn the full workflow overview",
    ch3_2: "Export clean base images from Revit",
    ch3_3: "Export clean base images from SketchUp",
    ch3_4: "Prepare your visuals for perfect AI rendering",
    ch4Title: "Chapter 4 — Prompting Mastery (Exterior + Interior)",
    ch4_1: "Learn what a prompt is and how to structure it",
    ch4_2: "Identify bad vs. good prompts",
    ch4_3: "Write professional prompts using a template",
    ch4_4: "Generate prompts with ChatGPT and mnml.ai",
    ch4_5: "Create optimized prompts for exterior renders",
    ch5Title: "Chapter 5 — Interior Rendering (Workflow + Animation)",
    ch5_1: "Prepare and export interior views",
    ch5_2: "Generate high-quality interior renders",
    ch5_3: "Enhance images using editing tools",
    ch5_4: "Create interior video animations",
    ch5_5: "Complete the full interior workflow step by step",
    ch6Title: "Chapter 6 — mnml.ai V2 + Studio AI Workflows",
    ch6_1: "Explore the updated mnml.ai interface",
    ch6_2: "Learn the Studio tool settings and workflow",
    ch6_3: "Generate exterior renders using Studio",
    ch6_4: "Create interior animations with Studio AI",
    ch6_5: "Use alternative interior animation methods",
    ch7Title: "Chapter 7 — Advanced Workflows: Style Transfer + Gemini AI",
    ch7_1: "Apply artistic styles using Style Transfer",
    ch7_2: "Use multiple references for exterior designs",
    ch7_3: "Create AI video animations from still images",
    ch7_4: "Combine mnml.ai with Gemini AI",
    ch7_5: "Edit images and produce final animations professionally",
    ch8Title: "Bonus Content Included",
    ch8_1: "Ready-to-use 3D Models (SketchUp + Revit) for practice",
    ch8_2: "High-quality reference images to improve your renders",
    ch8_3: "AI Prompt Library (organized by style + use case)",
    ch8_4: "Direct links to recommended AI tools",
    ch8_5: "Preset workflow templates to speed up your work",
    aiRenderPriceOld: "12000 DA",
    aiRenderPriceNew: "5999 DA",
  },
  ...
  fr: {
    ...
    privateSetif: "Appartement privé - Setif",
    privateAnnaba: "Appartement privé - Annaba",
    privateConstantine: "Appartement privé - Constantine",
    setif: "Setif",
    batna: "Batna",
    constantine: "Constantine",
    aliMendjeli: "Ali Mendjeli",
    ...
    aliSurf: "- 9 m² -",
    aliInfo:
      "Type: intérieure | Localisation: Ali Mendjeli, Constanine | Surface: 9 m²",
    hamla: "Hamla 2",
    hamlaSurf: "- 16 m² -",
    hamlaInfo:
    ...
    tazoultSurf: "- 80 m² -",
    tazoultInfo:
      "Type: intérieure | Localisation: Batna, Algérie | Surface: 80 m²",
    cityKouba: "City Kouba",
    citySurf: "- 43 m² -",
    cityInfo:
      "Type: intérieure | Location: City Kouba, Annaba | Surface: 43 m²",
    alger: "Alger",
    annaba: "Annaba",
    cheraga: "Chéraga",
    cheragaSurf: "- 17 m² -",
    cheragaInfo:
      "Type: intérieure | Localisation: Chéraga, Alger | Surface: 17 m²",
    oran: "Oran",
    hasnaoui: "Résidence Hasnaoui",
    hasnaouiSurf: "- 37 m² -",
    hasnaouiInfo:
      "Type: intérieure | Location: Résidence Hasnaoui, Oran | Surface: 37 m²",
    biskra: "Biskra",
    kantara: "El Kantara",
    kantaraSurf: "- 20 m² -",
    kantaraInfo:
      "Type: intérieure | Location: El Kantara, Biskra | Surface: 20 m²",
    privateBiskra: "Appartement privé - Biskra",
    indonesia: "Indonesia",
    bali: "Bali",
    baliSurf: "- 60 m² -",
    baliInfo: "Type: intérieure | Location: Bali, Indonésie | Surface: 60 m²",
    privateIndonesia: "Spa - Bali",
    france: "France",
    lyon: "Lyon",
    franceSurf: "- 120 m² -",
    franceInfo: "Type: intérieure | Location: Lyon, France | Surface: 120 m²",
    privateFrance: "Restaurant - Lyon",
    morocco: "Maroc",
    marrakesh: "Marrakech",
    marrakeshSurf: "- 75 m² -",
    marrakeshInfo:
      "Type: intérieure | Location: Marrakech, Morroco | Surface: 75 m²",
    privatemarrakesh: "Salon de coiffure - Marrakech",
    malaysia: "Malaisie",
    kuala: "Kuala Lumpur",
    kualaSurf: "- 70 m² -",
    kualaInfo:
      "Type: intérieure | Location: Kuala Lumpur, Malaisie | Surface: 70 m²",
    privateKuala: "Restaurant - Kuala Lumpur",
    ksa: "Arabie saoudite",
    riyadhh: "Riyad",
    riyadhhSurf: "- 130 m² -",
    riyadhhInfo:
      "Type: intérieure | Location: Riyad, Arabie saoudite | Surface: 130 m²",
    privateRiyadhh: "Bijouterie - Riyad",
    egypt: "Égypte",
    hurghada: "Hurghada",
    hurghadaSurf: "- 150 m² -",
    hurghadaInfo:
      "Type: intérieure | Location: Hurghada, Égypte | Surface: 150 m²",
    privateHurghada: "Restaurent - Hurghada",

    belvedere: "Belvédère",
    belvedereSurf: "- 55 m² -",
    belvedereInfo:
      "Type: intérieure | Location: Annaba, Algérie | Surface: 55 m²",
    ...
    draria: "Draria",
    drariaSurf: "- 16 m² -",
    drariaInfo: "Type: intérieure | Location: Draria, Alger | Surface: 16 m²",
    ...
    privateIndonesiaa: "Appartement privé - Indonésie",
    jakarta: "jakarta",
    jakartaSurf: "- 70 m² -",
    jakartaInfo:
      "Type: intérieure | Location: Jakarta, Indonésie | Surface: 70 m²",
    ...
    learningDesc:
      "Formations et enseignement d’un des meilleurs studios de design d’intérieur",

    dontforget: "N'oubliez pas de consulter nos projets !",

    publicHydra: "Studio de Pilates - Hydra",
    hydra: "Hydra",
    hydraSurf: "- 80 m² -",
    hydraInfo:
      "Type: intérieure | Localisation: Alger, Algérie | Surface: 80 m²",

    publicGymRiyadh: "Salle de sport - Doha",
    gymRiyadh: "Doha",
    gymRiyadhSurf: "- 90 m² -",
    gymRiyadhInfo:
      "Type: intérieure | Localisation: Doha, Qatar | Surface: 90 m²",

    saunaAnnabaInfo:
      "Type: intérieure | Localisation: Annaba, Algérie | Surface: 60 m²",

    algeria: "Algérie",

    publicSaunaAnnaba: "Sauna - Oran",

    privateMalaysia: "Appartement privé - Kuala Lumpur",

    skikda: "Skikda",
    privateSkikda: "Appartement privé - Skikda",
    skikdaInfo:
      "Type: intérieure | Localisation: Skikda, Algérie | Surface: 16 m²",

    azerbaijan: "Azerbaïdjan",
    baku: "Baku",
    privateAzerbaijan: "Appartement privé - Baku",
    azerbaijanInfo:
      "Type: intérieure | Localisation: Azerbaïdjan, Baku | Surface: 50 m²",
    saunaAnnabaSurf: "- 60 m² -",
    ...
    vietnam: "Vietnam",
    hanoi: "Hanoi",
    publicVietnam: "Stand - Hanoi",
    publicVietnamInfo:
      "Type: intérieure | Location: Vietnam, Hanoi | Surface: 25 m²",
    hanoiSurf: "- 25 m² -",

    publicBatna: "Café - Batna",
    publicbatnaInfo:
    ...
    rvencourseTitle:
      "Revit Architecture et Enscape -  À Partir de Zéro Au Rendu VR",
    rvencourseShortDesc:
    ...
    rvb1Obj:
      "OBJECTIF : LES ÉTUDIANTS COMPRENNENT COMMENT FONCTIONNE RHINO ET MODÉLISENT UN VOLUME SIMPLE.",
    rvb2Obj:
      "OBJECTIF : CRÉER UN MODÈLE PROPRE, PRÊT À RECEVOIR LES MATÉRIAUX.",
    rvb3Obj:
      "OBJECTIF : COMPRENDRE LES OUTILS ESSENTIELS DE V-RAY ET FAIRE UN PREMIER RENDU",
    rvb4Obj: "OBJECTIF : APPLIQUER DES MATÉRIAUX COHÉRENTS À TOUTE LA SCÈNE",
    rvb5Obj:
      "OBJECTIF : IMPORTER DES OBJETS SANS CASSER LA SCÈNE ET AMÉLIORER LE RENDU.",
    ...
    rvb1_4: "4. Surface simple: Extrude, PlanarSrf.",
    ...
    rvb2_4: "4. Introduction à Block pour répéter des éléments simples.",
    rvb2Ex:
    ...
    rvb3_3:
      "3. Matériaux de base V-Ray : Standard, Métal simple, Bois basique, Verre simple.",
    rvb3_4: "4. Réglages de rendu : Low, Medium, High.",
    rvb3Ex:
      "EXERCICE : MODÉLISER UNE PIÈCE MEUBLÉE SIMPLE (TABLE, CADRE, CAISSE SIMPLE).",
    ...
    rvb5_4: "4. Ajout de décor réaliste : plantes, chaises, petits objets.",
    rvb5Ex:
    ...
    rvb6_4:
      "4. Retouche simple via Photoshop/Canva : contraste, saturation, vignettage.",

    // Final Project
    rvbFinalProjTitle: "PROJET FINAL",
    rvbFinalProjDesc:
      "2 IMAGES FINALES PROPRES (INTÉRIEUR OU EXTÉRIEUR SIMPLE).",

    // Bonus Content
    rvbBonusContentTitle: "CONTENU FOURNI",
    ...
    course_programme: "Programme du Cours",
    level: "Tous les niveaux",
    buy_now: "Acheter maintenant",
    aiRenderTitle:
      "Maîtrise du Rendu IA : Transformez vos modèles SketchUp/Revit en rendus réalistes",
    aiRenderShortDesc:
      "Arrêtez de perdre des heures sur le rendu traditionnel — apprenez à produire des images et des scènes 3D de haute qualité en quelques minutes.",
    aiRenderLongDesc:
      "Le rendu prend trop de temps, les résultats réalistes sont difficiles à obtenir et les clients veulent toujours des changements rapidement. Ce cours vous apprend à créer des rendus et des animations réalistes professionnels en quelques minutes — avec moins d'effort, zéro stress et en utilisant des outils d'IA gratuits.",
    // Chapters
    ch1Title: "Chapitre 1 — Introduction et Fondamentaux",
    ch1_1: "Comprendre la structure du cours",
    ch1_2: "Notes importantes sur mnml.ai",
    ch2Title: "Chapitre 2 — Débuter avec mnml.ai",
    ch2_1: "Créer votre compte mnml.ai (méthode gratuite)",
    ch2_2: "Apprendre l'interface et les outils principaux",
    ch2_3: "Premiers pas pour naviguer et utiliser la plateforme correctement",
    ch3Title: "Chapitre 3 — Préparation du flux de travail (Revit + SketchUp)",
    ch3_1: "Aperçu complet du flux de travail",
    ch3_2: "Exporter des images de base propres depuis Revit",
    ch3_3: "Exporter des images de base propres depuis SketchUp",
    ch3_4: "Préparer vos visuels pour un rendu IA parfait",
    ch4Title: "Chapitre 4 — Maîtrise des Prompts (Extérieur + Intérieur)",
    ch4_1: "Apprendre ce qu'est un prompt et comment le structurer",
    ch4_2: "Identifier les mauvais vs bons prompts",
    ch4_3: "Rédiger des prompts professionnels à l'aide d'un modèle",
    ch4_4: "Générer des prompts avec ChatGPT et mnml.ai",
    ch4_5: "Créer des prompts optimisés pour les rendus extérieurs",
    ch5Title: "Chapitre 5 — Rendu d'intérieur (Flux de travail + Animation)",
    ch5_1: "Préparer et exporter des vues intérieures",
    ch5_2: "Générer des rendus d'intérieur de haute qualité",
    ch5_3: "Améliorer les images à l'aide d'outils d'édition",
    ch5_4: "Créer des animations vidéo d'intérieur",
    ch5_5: "Compléter le flux de travail intérieur étape par étape",
    ch6Title: "Chapitre 6 — mnml.ai V2 + Flux de travail Studio AI",
    ch6_1: "Explorer l'interface mise à jour de mnml.ai",
    ch6_2: "Apprendre les paramètres et le flux de travail de l'outil Studio",
    ch6_3: "Générer des rendus extérieurs à l'aide de Studio",
    ch6_4: "Créer des animations intérieures avec Studio AI",
    ch6_5: "Utiliser des méthodes alternatives d'animation intérieure",
    ch7Title:
      "Chapitre 7 — Flux de travail avancés : Transfert de style + Gemini AI",
    ch7_1: "Appliquer des styles artistiques via Style Transfer",
    ch7_2: "Utiliser plusieurs références pour les designs extérieurs",
    ch7_3: "Créer des animations vidéo IA à partir d'images fixes",
    ch7_4: "Combiner mnml.ai avec Gemini AI",
    ch7_5:
      "Éditer les images et produire des animations finales professionnellement",
    ch8Title: "Contenu Bonus Inclus",
    ch8_1: "Modèles 3D prêts à l'emploi (SketchUp + Revit) pour la pratique",
    ch8_2: "Images de référence de haute qualité pour améliorer vos rendus",
    ch8_3:
      "Bibliothèque de prompts IA (organisée par style + cas d'utilisation)",
    ch8_4: "Liens directs vers les outils d'IA recommandés",
    ch8_5: "Modèles de flux de travail prédéfinis pour accélérer votre travail",
    aiRenderPriceOld: "12000 DA",
    aiRenderPriceNew: "5999 DA",
  },
  ...
  ar: {
    ...
    privateAnnaba: "شقة خاصة - عنابة",
    privateAlger: "شقة خاصة - الجزائر العاصمة",
    privateSetif: "شقة خاصة - سطيف",
    batna: "باتنة",
    constantine: "قسنطينة",
    aliMendjeli: "علي منجلي",
    privateConstantine: "شقة خاصة - قسنطينة",
    riyadh: "حي الرياض",
    riyadhSurf: "- 80 م² -",
    ...
    aliSurf: "- 9 م² -",
    aliInfo: "النوع: داخلية | المنطقة: علي منجلي، قسنطينة | المساحة: 9 م²",
    hamla: "حملة 2",
    hamlaSurf: "- 16 م² -",
    ...
    tazoult: "تازولت",
    tazoultSurf: "- 80 م² -",
    tazoultInfo: "النوع: داخلية | المنطقة: باتنة، الجزائر | المساحة: 80 م²",
    cityKouba: "حي قبة",
    citySurf: "- 43 م² -",
    ...
    cheragaSurf: "- 17 م² -",
    cheragaInfo:
      "النوع: داخلية | المنطقة: شراقة، الجزائر العاصمة | المساحة: 17 م²",
    oran: "وهران",
    hasnaoui: "مجمع حسناوي",
    hasnaouiSurf: "- 37 م² -",
    hasnaouiInfo:
      "النوع: داخلية | المنطقة: مجمع حسناوي، وهران | المساحة: 37 م²",
    biskra: "بسكرة",
    kantara: "القنطرة",
    kantaraSurf: "- 20 م² -",
    kantaraInfo: "النوع: داخلية | المنطقة: القنطرة، بسكرة | المساحة: 20 م²",
    privateBiskra: "شقة خاصة - بسكرة",
    indonesia: "إندونيسيا",
    bali: "بالي",
    baliSurf: "- 60 م² -",
    baliInfo: "النوع: داخلية | المنطقة: بالي، إندونيسيا | المساحة: 60 م²",
    privateIndonesia: " منتجع صحي - بالي",
    france: "فرنسا",
    lyon: "ليون",
    franceSurf: "-  120 م² -",
    franceInfo: "النوع: داخلية | المنطقة: ليون، فرنسا | المساحة: 120 م²",
    privateFrance: "مطعم - ليون",
    morocco: "المغرب",
    marrakesh: "مراكش",
    marrakeshSurf: "-  75 م² -",
    marrakeshInfo: "النوع: داخلية | المنطقة: مراكش، المغرب | المساحة: 75 م²",
    privatemarrakesh: "محل حلاقة - مراكش",
    malaysia: "ماليزيا",
    kuala: "كوالالمبور",
    kualaSurf: "-  70 م² -",
    kualaInfo: "النوع: داخلية | المنطقة: كوالالمبور، ماليزيا | المساحة: 75 م²",
    privateKuala: "مطعم - كوالالمبور",
    ksa: "السعودية",
    riyadhh: "الرياض",
    riyadhhSurf: "-  130 م² -",
    riyadhhInfo: "النوع: داخلية | المنطقة: الرياض، السعودية | المساحة: 130 م²",
    privateRiyadhh: "محل مجوهرات - الرياض",
    egypt: "مصر",
    hurghada: "الغردقة",
    hurghadaSurf: "-  150 م² -",
    ...
    belvedereSurf: "- 55 م² -",
    belvedereInfo: "النوع: داخلية | المنطقة: عنابة، الجزائر | المساحة: 55 م²",
    ...
    drariaSurf: "- 16 م² -",
    drariaInfo:
      "النوع: داخلية | المنطقة: درارية، الجزائر العاصمة | المساحة: 16 م²",

    sidiMabrouk: "سيدي مبروك",
    sidiMabroukSurf: "- 12 م² -",
    sidiMabroukInfo:
      "النوع: داخلية | المنطقة: سيدي مبروك، قسنطينة | المساحة: 12 م²",

    belvedereSauna: "بلفودار -2-",
    belvedereSaunaSurf: "- 60 م² -",
    belvedereSaunaInfo:
      "النوع: داخلية | المنطقة: بلفودار، قسنطينة | المساحة: 60 م²",
    ...
    privateIndonesiaa: "شقة خاصة - إندونيسيا",
    jakarta: "جاكارتا",
    jakartaSurf: "- 70 م² -",
    ...
    dontforget: "لا تنسَ الاطلاع على مشاريعنا!",

    // saunaAnnabaInfo:"Type: interior | Location: Annaba, Algeria | Surface: 60 m²",
    saunaAnnabaInfo: "النوع: داخلية | المنطقة: عنابة، الجزائر | المساحة: 60 م²",

    publicHydra: "استوديو بيلاتيس - حيدرة",
    hydra: "حيدرة",
    hydraSurf: "- 80 م² -",
    hydraInfo:
      "النوع: داخلية | المنطقة: الجزائر العاصمة، الجزائر | المساحة: 80 م²",

    // publicBatna:"صالة رياضية - باتنة",
    publicGymRiyadh: "صالة رياضية - الدوحة",
    gymRiyadh: "الدوحة",
    gymRiyadhSurf: "- 90 م² -",
    gymRiyadhInfo: "النوع: داخلية | المنطقة: الدوحة، قطر | المساحة: 90 م²",

    publicSaunaAnnaba: "حمام بخاري - وهران",

    algeria: "الجزائر",

    privateMalaysia: "شقة خاصة - كوالالمبور",

    skikda: "سكيكدة",
    privateSkikda: "شقة خاصة - سكيكدة",
    // skikdaInfo:"النوع: داخلية | المنطقة: سكيكدة، سكيكدة | المساحة: 16 م²",

    azerbaijan: "أذربيجان",
    baku: "باكو",
    privateAzerbaijan: "شقة خاصة - باكو",
    azerbaijanInfo: "النوع: داخلية | المنطقة: أذربيجان، باكو | المساحة: 50 م²",
    ...
    vietnam: "فيتنام",
    hanoi: "هانوي",
    publicVietnam: "كشك المعارض - هانوي",
    publicVietnamInfo:
      "النوع: داخلية | المنطقة: فيتنام، هانوي | المساحة: 25 م²",
    hanoiSurf: "- 25 م² -",
    ...
    rvb1Obj: "الهدف: أن يفهم الطلاب كيفية عمل راينو وينمذجوا مجسمًا بسيطًا.",
    rvb2Obj: "الهدف: إنشاء نموذج نظيف، جاهز لاستقبال المواد.",
    rvb3Obj: "الهدف: فهم الأدوات الأساسية لـ V-Ray وإجراء أول عملية رندر.",
    rvb4Obj: "الهدف: تطبيق مواد متناسقة على المشهد بأكمله.",
    rvb5Obj: "الهدف: استيراد كائنات دون إتلاف المشهد وتحسين الرندر.",
    rvb6Obj: "الهدف: رندر صورتين نهائيتين + تعديلات بسيطة.",

    // Course Programme
    rvb1se: "الجلسة 1: مقدمة وأساسيات راينو",
    rvb1_1: "1. واجهة راينو: المناظير، اللوحات، أشرطة الأدوات.",
    rvb1_2: "2. التنقل ثلاثي الأبعاد: تقريب، تحريك، دوران.",
    rvb1_3: "3. المنحنيات الأساسية: خط، بوليلاين، مستطيل.",
    rvb1_4: "4. سطح بسيط: Extrude, PlanarSrf.",
    rvb1_5: "5. التنظيم: الطبقات (Layers)، التحديد، الإخفاء، القفل.",
    rvb1Ex: "تمرين: نمذجة غرفة صغيرة (أرضية + 4 جدران + فتحة).",

    rvb2se: "الجلسة 2: نمذجة بسيطة (داخلية أو كائن صغير)",
    rvb2_1: "1. استيراد مخطط DWG/PDF وضبطه حسب المقياس.",
    rvb2_2: "2. بثق (Extrusion)، إزاحة (Offset).",
    rvb2_3: "3. إنشاء أرضية، سقف، نعلات (plinthes).",
    rvb2_4: "4. مقدمة إلى البلوكات (Block) لتكرار العناصر البسيطة.",
    rvb2Ex: "تمرين: نمذجة غرفة مفروشة بسيطة (طاولة، إطار، صندوق بسيط).",

    rvb3se: "الجلسة 3: مقدمة إلى V-Ray (الأساسيات الضرورية)",
    rvb3_1:
      "1. واجهة V-Ray: محرر الأصول (Asset Editor)، Frame Buffer, LightMix.",
    rvb3_2: "2. الإضاءة الرئيسية: Dome Light (HDRI).",
    rvb3_3: "3. مواد V-Ray الأساسية: قياسية، معدن بسيط، خشب أساسي، زجاج بسيط.",
    rvb3_4: "4. إعدادات الرندر: منخفض، متوسط، عالي.",
    rvb3Ex: "تمرين: نمذجة غرفة مفروشة بسيطة (طاولة، إطار، صندوق بسيط).",

    rvb4se: "الجلسة 4: المواد + الإضاءة الأساسية",
    rvb4_1: "1. الاستخدام الحصري لمكتبة V-Ray الرسمية.",
    rvb4_2: "2. كيفية تطبيق المواد بشكل صحيح.",
    rvb4_3:
      "3. الإعدادات الأساسية: الخشونة (roughness)، الانعكاس (reflection).",
    rvb4_4: "4. إضاءة داخلية بسيطة: Rect Light, Sphere Light.",
    rvb4Ex: "تمرين: إنشاء صورة بسيطة ولكن نظيفة.",

    rvb5se: "الجلسة 5: استيراد الكائنات وسير العمل في V-Ray",
    rvb5_1: "1. أهمية كائنات .vrmat, .obj, .3dm.",
    rvb5_2: "2. متى نستخدم V-Ray Proxy.",
    rvb5_3: "3. تنظيف نموذج مستورد: التوجيه، Normals, المقياس.",
    rvb5_4: "4. إضافة ديكور واقعي: نباتات، كراسي، كائنات صغيرة.",
    rvb5Ex: "تمرين: إضافة 5 كائنات مستوردة إلى المشهد + إعادة الرندر.",

    rvb6se: "الجلسة 6: الإنهاء والمعالجة البسيطة (Post-Production)",
    rvb6_1: "1. الكاميرا: الوضع الصحيح.",
    rvb6_2: "2. Lightmix لتعديل الإضاءة.",
    rvb6_3: "3. تصدير بدقة عالية.",
    rvb6_4:
      "4. تعديل بسيط عبر Photoshop/Canva: التباين، التشبع، التظليل (vignette).",

    // Final Project
    rvbFinalProjTitle: "المشروع النهائي",
    rvbFinalProjDesc: "صورتان نهائيتان نظيفتان (داخلية أو خارجية بسيطة).",

    // Bonus Content
    rvbBonusContentTitle: "المحتوى المقدم",
    ...
    buy_now: "اشترِ الآن",
    aiRenderTitle:
      "إتقان الرندرة بالذكاء الاصطناعي: حول نماذج SketchUp/Revit إلى رندرة واقعية",
    aiRenderShortDesc:
      "توقف عن إضاعة الساعات في الرندرة التقليدية — تعلم كيفية إنتاج صور ومناهد ثلاثية الأبعاد عالية الجودة في دقائق فقط.",
    aiRenderLongDesc:
      "عملية الرندرة تستغرق وقتاً طويلاً، والنتائج الواقعية يصعب تحقيقها، والعملاء يريدون دائماً التغييرات بسرعة. تعلمك هذه الدورة كيفية إنشاء رندرة ورسوم متحركة واقعية احترافية في دقائق — بجهد أقل وضغط معدوم وباستخدام أدوات ذكاء اصطناعي مجانية.",
    // Chapters
    ch1Title: "الفصل 1 — مقدمة وأساسيات",
    ch1_1: "فهم هيكلية الدورة",
    ch1_2: "ملاحظات هامة حول mnml.ai",
    ch2Title: "الفصل 2 — البدء مع mnml.ai",
    ch2_1: "إنشاء حساب mnml.ai بالطريقة المجانية",
    ch2_2: "تعلم الواجهة والأدوات الرئيسية",
    ch2_3: "الخطوات الأولى للتنقل واستخدام المنصة بشكل صحيح",
    ch3Title: "الفصل 3 — تحضير سير العمل (Revit + SketchUp)",
    ch3_1: "نظرة عامة على سير العمل الكامل",
    ch3_2: "تصدير صور أساسية نظيفة من Revit",
    ch3_3: "تصدير صور أساسية نظيفة من SketchUp",
    ch3_4: "تحضير مرئياتك لرندرة مثالية بالذكاء الاصطناعي",
    ch4Title: "الفصل 4 — إتقان الأوامر النصية (خارجي + داخلي)",
    ch4_1: "تعلم ماهية الأمر النصي (Prompt) وكيفية هيكلته",
    ch4_2: "التفريق بين الأوامر النصية الجيدة والسيئة",
    ch4_3: "كتابة أوامر نصية احترافية باستخدام قالب",
    ch4_4: "توليد الأوامر النصية باستخدام ChatGPT و mnml.ai",
    ch4_5: "إنشاء أوامر نصية محسنة للرندرة الخارجية",
    ch5Title: "الفصل 5 — الرندرة الداخلية (سير العمل + الرسوم المتحركة)",
    ch5_1: "تحضير وتصدير المشاهد الداخلية",
    ch5_2: "توليد رندرة داخلية عالية الجودة",
    ch5_3: "تحسين الصور باستخدام أدوات التحرير",
    ch5_4: "إنشاء رسوم متحركة فيديو داخلية",
    ch5_5: "إكمال سير العمل الداخلي بالكامل خطوة بخطوة",
    ch6Title: "الفصل 6 — mnml.ai V2 + سير عمل Studio AI",
    ch6_1: "استكشاف واجهة mnml.ai المحدثة",
    ch6_2: "تعلم إعدادات أداة Studio وسير العمل",
    ch6_3: "توليد رندرة خارجية باستخدام Studio",
    ch6_4: "إنشاء رسوم متحركة داخلية باستخدام Studio AI",
    ch6_5: "استخدام طرق بديلة للرسوم المتحركة الداخلية",
    ch7Title: "الفصل 7 — سير عمل متقدم: نقل النمط + Gemini AI",
    ch7_1: "تطبيق أنماط فنية باستخدام Style Transfer",
    ch7_2: "استخدام مراجع متعددة للتصاميم الخارجية",
    ch7_3: "إنشاء رسوم متحركة بالذكاء الاصطناعي من صور ثابتة",
    ch7_4: "الجمع بين mnml.ai و Gemini AI",
    ch7_5: "تحرير الصور وإنتاج الرسوم المتحركة النهائية باحترافية",
    ch8Title: "محتوى إضافي متضمن",
    ch8_1: "نماذج ثلاثية الأبعاد جاهزة (SketchUp + Revit) للتدريب",
    ch8_2: "صور مرجعية عالية الجودة لتحسين الرندرة الخاصة بك",
    ch8_3: "مكتبة أوامر نصية (منظمة حسب النمط + حالة الاستخدام)",
    ch8_4: "روابط مباشرة لأدوات الذكاء الاصطناعي الموصى بها",
    ch8_5: "قوالب سير عمل جاهزة لتسريع عملك",
    aiRenderPriceOld: "12000 دج",
    aiRenderPriceNew: "5999 دج",
  },
};
